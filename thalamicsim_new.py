...
def run(vmcircuit, i2t, tstop, seed, key, v_init=-78.0, all_section_recording=False,
        all_synapse_recording=False, current_recording=[], rec_invl=100.0, varname=["_ref_v"], dt=0.1):
...
def run_simulation(cellid, lesioned_flag, tstop, seed, key, **kwargs):
  ...
  all_section_recording = all_synapse_recording = True
  dt = 1.0
  rec_invl=100.0
  varname=["_ref_v"]
