...
#define m_instances _p[3]
#define m_timeCourse_TIME_SCALE _p[4]
#define m_timeCourse_VOLT_SCALE _p[5]
#define m_steadyState_rate _p[6]
#define m_steadyState_midpoint _p[7]
#define m_steadyState_scale _p[8]
#define m_q10Settings_q10Factor _p[9]
#define m_q10Settings_experimentalTemp _p[10]
#define m_q10Settings_TENDEGREES _p[11]
#define shift _p[12]
#define gion _p[13]
#define m_timeCourse_V _p[14]
#define m_timeCourse_t _p[15]
#define m_steadyState_x _p[16]
#define m_q10Settings_q10 _p[17]
#define m_rateScale _p[18]
#define m_fcond _p[19]
#define m_inf _p[20]
#define m_tauUnscaled _p[21]
#define m_tau _p[22]
...
#define m_min _p[26]
#define output _p[27]
#define i_output _p[28]
#define m_q _p[29]
#define temperature _p[30]
#define ek _p[31]
#define ik _p[32]
#define g _p[33]
#define rate_m_q _p[34]
#define Dm_q _p[35]
#define v _p[36]
#define _g _p[37]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "gmin_iM", "S/cm2",
 "conductance_iM", "uS",
 "m_timeCourse_TIME_SCALE_iM", "ms",
 "m_timeCourse_VOLT_SCALE_iM", "mV",
 "m_steadyState_midpoint_iM", "mV",
 "m_steadyState_scale_iM", "mV",
 "m_q10Settings_experimentalTemp_iM", "K",
 "m_q10Settings_TENDEGREES_iM", "K",
 "shift_iM", "mV",
 "gion_iM", "S/cm2",
 "m_timeCourse_t_iM", "ms",
 "m_tauUnscaled_iM", "ms",
 "m_tau_iM", "ms",
 0,0
};
...
"iM",
 ...
 "conductance_iM",
 "m_instances_iM",
 "m_timeCourse_TIME_SCALE_iM",
 "m_timeCourse_VOLT_SCALE_iM",
 "m_steadyState_rate_iM",
 "m_steadyState_midpoint_iM",
 "m_steadyState_scale_iM",
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	m_steadyState_midpoint = -36.7;
 	m_steadyState_scale = 9.48;
 	m_q10Settings_q10Factor = 2.6;
 	m_q10Settings_experimentalTemp = 308.15;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 iM /home/francesco/Desktop/MeMo/modfiles/iM.mod\n");
...
static int  rates ( _threadargsproto_ ) {
   ...
   m_timeCourse_t = ( 13.4 + 26.3 * exp ( - ( ( m_timeCourse_V - 29.7 + shift ) / 30.3 ) * ( ( m_timeCourse_V - 29.7 + shift ) / 30.3 ) ) ) * m_timeCourse_TIME_SCALE ;
   m_steadyState_x = m_steadyState_rate / ( 1.0 + exp ( 0.0 - ( v - m_steadyState_midpoint + shift ) / m_steadyState_scale ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/francesco/Desktop/MeMo/modfiles/iM.mod";
static const char* nmodl_file_text = 
