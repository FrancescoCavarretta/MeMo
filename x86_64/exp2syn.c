...
#define nrn_init _nrn_init__MeMo_Exp2Syn
#define _nrn_initial _nrn_initial__MeMo_Exp2Syn
#define nrn_cur _nrn_cur__MeMo_Exp2Syn
#define _nrn_current _nrn_current__MeMo_Exp2Syn
#define nrn_jacob _nrn_jacob__MeMo_Exp2Syn
#define nrn_state _nrn_state__MeMo_Exp2Syn
#define _net_receive _net_receive__MeMo_Exp2Syn 
#define state state__MeMo_Exp2Syn 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 MeMo_Exp2Syn /home/francesco/Desktop/MeMo/modfiles/exp2syn.mod\n");
...
{  double* _p; Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 ...
 _tsav = t; {
    ...
    double __state = A;
    double __primary = (A + g_max * factor) - __state;
 ...
 A = A + g_max * factor ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    /* discon state adjustment for cnexp case (rate uses no local variable) */
    double __state = B;
    double __primary = (B + g_max * factor) - __state;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/francesco/Desktop/MeMo/modfiles/exp2syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
